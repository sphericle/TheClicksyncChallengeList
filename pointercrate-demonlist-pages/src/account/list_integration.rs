            ...
            div.left {
                div.panel.fade.js-collapse style="text-align: left; padding: 10px 20px" {
                    ...
                    @if let Some(ref claim) = player_claim {
                        @if claim.verified {
                            div.overlined.pad.js-collapse-content #claims-claim-panel {
                                ...
                                p style = "display: none;" {
                                    "Clicking the above button lets you set your claimed player's statsviewer flag via IP Geolocation. To offer this functionality, pointercrate uses "
