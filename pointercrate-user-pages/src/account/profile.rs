                ...
                div.panel.fade {
                    ...
                    div.flex.space.wrap #things {
                        ...
                        span {
                            ...
                            (permission_string)
                            p {
                                "The permissions you have on pointercrate. 'List ...' means you're a member of the list team. 'Moderator'  and 'Administrator' mean you're part of pointercrate's staff team."
                            }
                        }
                    }
                    div.flex.no-stretch {
